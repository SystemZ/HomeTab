...
(
    ...
    `token`      char(36) CHARACTER SET ascii                                 NOT NULL,
    `token_push` varchar(32)                                                  NOT NULL DEFAULT '',
    `created_at` datetime                                                     NOT NULL,
    `updated_at` datetime                                                     NOT NULL,
    `deleted_at` datetime                                                              DEFAULT NULL,
    PRIMARY KEY (`id`)
...
(
    ...
    `val_str`    varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `webhook_receivers`
--
...
-- Dump completed on 2020-06-04  1:56:14
